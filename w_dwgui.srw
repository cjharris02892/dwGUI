...
uo_XPListBar.of_addLink(ll_group, 'To be, or not to be, that is the question', '', '')
...
uo_XPListBar.of_addLabel(ll_group, 'Text 3', '', '')
uo_XPListBar.of_addLabel(ll_group, 'Text 4', '', 'Text 4 ToolTip')
uo_XPlistBar.of_addSeparator(ll_group)
...
ll_group									= uo_XPListBar.of_addGroup('Enable', '', '')

uo_XPListBar.of_addLabel(ll_group, 'Paste', '', '')
uo_XPListBar.of_addLabel(ll_group, 'Text 1', '', '')
uo_XPListBar.of_addLabel(ll_group, 'Exit', '', '')
